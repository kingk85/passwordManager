<?php
//-------------------------------------------------------------------------------------------------------------  
//                          Crypter By Ugo Cirmignani for Databases or Files Crypt                            		
//-------------------------------------------------------------------------------------------------------------  
// This script is a Cryptography tool, it can be used for Crypt strings or files without any external	
// library, using a strong encryption algorithm.  		                                       	 		    
// To use this script you have to include the file crypter.php in each page that needs the Cryptography  	  	    
// functions.                                                                                                					  		    
//                                                                        	                            						       		   
...
for ( $j = 0 ; $j < $lenPASS ; $j++ ) 
	...
	for ( $j = $lenPASS ; $j < MAX_PWL_LEN; $j++ ) //Azzera gli altri elementi del vettore?!
	{
	$NUM_ORDINE[$j] = 300;
	$ARR_ORIGINALE[$j] = 300;
	}
